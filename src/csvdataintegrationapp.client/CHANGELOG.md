...
- Create Angular project with ng: `ng new csvdataintegrationapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`csvdataintegrationapp.client.esproj`).
